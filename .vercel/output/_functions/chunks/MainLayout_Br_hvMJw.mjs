import { c as createComponent, s as spreadAttributes, u as unescapeHTML, a as renderTemplate, m as maybeRenderHead, b as createAstro, r as renderComponent, d as addAttribute, i as defineScriptVars, h as renderSlot, F as Fragment, j as renderHead, k as renderScript } from './astro/server_akqI5NS5.mjs';
import 'kleur/colors';
import './index_MaT6fT73.mjs';
import { $ as $$Image } from './_astro_assets_DQ0jitgb.mjs';
import 'clsx';
/* empty css                         */
...
const $$ShortForm = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<form class="bg-[#292A32] px-10 py-14 rounded-[14px] gap-5 h-full flex flex-col sm:flex-row items-center justify-center"> <div class="w-full sm:w-[55%]"> <input type="text" id="email" name="email" placeholder="Email Anda" class="bg-transparent w-full px-[35px] py-5 border rounded-[14px] focus:outline-none"> </div> <button type="submit" name="submit" class="w-full sm:w-[45%] btn-tertiary">Berlangganan Info Panen</button> </form>`;
}, "/Users/nanda/Documents/Hackaton/mgb/src/components/ui/ShortForm.astro", void 0);
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  const links = [
    { name: "Tim Inti", href: "#about" },
    { name: "Fitur Utama", href: "#services" },
    { name: "Implementasi", href: "#cases" },
  ...
  })} </ul> </div> <div class="flex flex-col lg:flex-row mt-[66px] mb-[51px]"> <div class="flex text-center lg:text-start flex-col w-full lg:w-[30%]"> <h3 class="mb-5 text-center md:text-left text-2xl text-green">Kontak PanenLangsung</h3> <div class="flex flex-col justify-between gap-4"> <span> Email: halo@panenlangsung.id </span> <span> Telepon: (021) 1500-321 </span> <span class="lg:w-3/4">
Alamat: Jl. Agrikultura No. 12, Jakarta, Indonesia
</span> </div> </div> <div class="flex-grow my-10 lg:my-0 lg:ml-12"> ${renderComponent($$result, "ShortForm", $$ShortForm, {})} </div> </div> </div> <div class="h-[1px] bg-gray mb-5"></div> <div class="flex flex-col lg:flex-row h-20 justify-center mt-4 text-center md:justify-between md:mt-0"> <span>2026 PanenLangsung - Dibangun dengan <a class="underline" target="_blank" href="https://astro.build">Astro</a> untuk platform penjualan hasil panen.</span>&nbsp
<span>
Hak cipta © PanenLangsung
</span> </div> </div> </div> </section>`;
}, "/Users/nanda/Documents/Hackaton/mgb/src/components/ui/Footer.astro", void 0);
...
}, "/Users/nanda/Documents/Hackaton/mgb/node_modules/astro-navbar/src/Astronav.astro", void 0);
...
}, "/Users/nanda/Documents/Hackaton/mgb/node_modules/astro-navbar/src/components/MenuIcon.astro", void 0);
...
}, "/Users/nanda/Documents/Hackaton/mgb/node_modules/astro-navbar/src/components/OpenIcon.astro", void 0);
...
}, "/Users/nanda/Documents/Hackaton/mgb/node_modules/astro-navbar/src/components/CloseIcon.astro", void 0);
...
}, "/Users/nanda/Documents/Hackaton/mgb/node_modules/astro-navbar/src/components/MenuItems.astro", void 0);
...
}, "/Users/nanda/Documents/Hackaton/mgb/node_modules/astro-navbar/src/components/Dropdown.astro", void 0);
...
}, "/Users/nanda/Documents/Hackaton/mgb/node_modules/astro-navbar/src/components/DropdownSubmenu.astro", void 0);
...
}, "/Users/nanda/Documents/Hackaton/mgb/node_modules/astro-navbar/src/components/DropdownItems.astro", void 0);
...
}, "/Users/nanda/Documents/Hackaton/mgb/node_modules/astro-navbar/src/components/StickyHeader.astro", void 0);
...
const $$Navbar = createComponent(($$result, $$props, $$slots) => {
  ...
  const menuitems = [
    ...
    { href: "/#sponsors", label: "Mitra" },
    { href: "/#catalog", label: "Katalog" }
  ];
  const navButton = { href: "/login", label: "Masuk ke Platform" };
...
}, "/Users/nanda/Documents/Hackaton/mgb/src/components/ui/Navbar.astro", void 0);

const title = "PanenLangsung";
const image = {"src":"https://github.com/manulthanura/Positivus/raw/main/public/cover.png","alt":"PanenLangsung"};
const siteData = {
  title,
  image,
};
...
}, "/Users/nanda/Documents/Hackaton/mgb/src/components/seo/Seo.astro", void 0);
...
}, "/Users/nanda/Documents/Hackaton/mgb/src/layouts/MainHead.astro", void 0);
...
const $$MainLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" data-astro-cid-ouamjn2i> ${renderComponent($$result, "MainHead", $$MainHead, { ...props, "data-astro-cid-ouamjn2i": true })}${renderScript($$result, "/Users/nanda/Documents/Hackaton/mgb/src/layouts/MainLayout.astro?astro&type=script&index=0&lang.ts")}${maybeRenderHead()}<body class="bg-white font-grotesk" data-astro-cid-ouamjn2i> <main data-astro-cid-ouamjn2i> ${renderComponent($$result, "Navbar", $$Navbar, { "data-astro-cid-ouamjn2i": true })} ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-ouamjn2i": true })} </main> </body></html>`;
}, "/Users/nanda/Documents/Hackaton/mgb/src/layouts/MainLayout.astro", void 0);
